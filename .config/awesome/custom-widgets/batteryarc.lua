...
local WIDGET_DIR = HOME .. '/.config/awesome/assets/icons'
...
local function worker(user_args)
	...
	local font = args.font or 'Fira Code Nerd Font 1'
	...
	local low_level_color = args.low_level_color or color.red
	...
	local function show_battery_status()
		awful.spawn.easy_async([[bash -c 'acpi']],
			function(stdout, _, _, _)
				...
				--     text = stdout,
				--     title = '<span font="Fira Code Nerd Font Bold 14" color="#a9b1d6">Battery status </span>',
				--     timeout = 5,
				--     width = 200,
