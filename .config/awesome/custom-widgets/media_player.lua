...
Separator.forced_height = dpi(400)
...
local art = wibox.widget {
	image = os.getenv("HOME") .. "/.config/awesome/custom-widgets/control_dashlets/assets/music.svg",
	resize = true,
...
local title_widget = wibox.widget {
	markup = '<span color="' ..
		color.redish_white .. '" font="Fira Code Nerd Font bold 10">' .. "Nothing Playing" .. '</span>',
	align = 'center',
	valign = 'top',
	widget = wibox.widget.textbox,
...
local artist_widget = wibox.widget {
	markup = '<span color="' ..
		color.white .. '" font="Fira Code Nerd Font 10">' .. "Unknown Artist" .. '</span>',
	align = 'center',
	valign = 'bottom',
	widget = wibox.widget.textbox,
	font = "Fira Code Nerd Font 10",
...
playerctl:connect_signal("metadata",
	function(_, title, artist, album_path, album, new, player_name)
		...
		title_widget:set_markup_silently('<span color="' ..
			color.red .. '" font="Fira Code Nerd Font 8 Bold">' .. title .. '</span>')
		artist_widget:set_markup_silently('<span color="' ..
			color.white .. '" font="Fira Code Nerd Font 11">' .. artist .. '</span>')
	end)
...
local length_text = wibox.widget {
	markup = '<span color="' ..
		color.redish_white .. '" font="Fira Code Nerd Font 11">' .. "00:00" .. '</span>',
	align = 'center',
	valign = 'top',
	widget = wibox.widget.textbox,
	font = "Fira Code Nerd Font 12",
	...
	awful.spawn.easy_async("timeout 0.4s playerctl -F metadata -f '{{mpris:length}}'", function(stdout)
		if stdout == "" then
			...
			length_text:set_markup_silently('<span color="' ..
				color.redish_white .. '" font="Fira Code Nerd Font 11">' .. text .. '</span>')
		elseif stdout == nil then
			...
			length_text:set_markup_silently('<span color="' ..
				color.redish_white ..
				'" font="Fira Code Nerd Font 11">' .. formattedminutes .. ':' .. formattedseconds .. '</span>')
		else
...
local button = wibox.widget {
	image = os.getenv("HOME") .. "/.config/awesome/custom-widgets/control_dashlets/assets/pause.png",
	resize = true,
	forced_height = dpi(40),
	forced_width = dpi(40),
	widget = wibox.widget.imagebox,
...
button:buttons(gears.table.join(
	awful.button({}, 1, function()
		...
		if is_playing then
			if title_widget.markup == '<span color="' .. color.redish_white .. '" font="Fira Code Nerd Font bold 12">' .. "Nothing Playing" .. '</span>' then
				button:set_image(os.getenv("HOME") .. "/.config/awesome/custom-widgets/control_dashlets/assets/pause.png")
			else
				button:set_image(os.getenv("HOME") .. "/.config/awesome/custom-widgets/control_dashlets/assets/play2.png")
			end
		else
			if title_widget.markup == '<span color="' .. color.redish_white .. '" font="Fira Code Nerd Font bold 12">' .. "Nothing Playing" .. '</span>' then
				button:set_image(os.getenv("HOME") .. "/.config/awesome/custom-widgets/control_dashlets/assets/pause.png")
...
local next = wibox.widget {
	image = os.getenv("HOME") .. "/.config/awesome/custom-widgets/control_dashlets/assets/next-button.png",
	resize = true,
	forced_height = dpi(40),
	forced_width = dpi(40),
	widget = wibox.widget.imagebox,
...
local previous = wibox.widget {
	image = os.getenv("HOME") .. "/.config/awesome/custom-widgets/control_dashlets/assets/previous.png",
	resize = true,
	forced_height = dpi(40),
	forced_width = dpi(40),
	widget = wibox.widget.imagebox,
...
local forward = wibox.widget {
	image = os.getenv("HOME") .. "/.config/awesome/custom-widgets/control_dashlets/assets/15sforward.png",
	resize = true,
...
local backward = wibox.widget {
	image = os.getenv("HOME") .. "/.config/awesome/custom-widgets/control_dashlets/assets/15sbackward.png",
	resize = true,
	forced_height = dpi(45),
	forced_width = dpi(45),
	widget = wibox.widget.imagebox,
