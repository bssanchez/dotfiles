...
Separator.forced_height = dpi(220)
Separator.forced_width = dpi(220)

-- Volume Icon Image
local image = wibox.widget {
	image = os.getenv("HOME") .. '/.config/awesome/custom-widgets/osds/assets/volume.png',
...
local volume_text = wibox.widget {
	markup = '<span color="' .. color.blueish_white .. '" font="Fira Code Nerd Font Bold 10">' .. 'Volume' .. '</span>'
	,
...
local volume_percentage = wibox.widget {
	markup = '<span color="' ..
		color.blueish_white .. '" font="Fira Code Nerd Font Bold 10">' .. volume_slider.value .. '</span>'
	,
	widget = wibox.widget.textbox,
	fg = color.white,
}
...
local update_volume_slider = function()
	awful.spawn.easy_async("amixer sget Master", function(stdout)
		...
		volume_percentage.markup = '<span color="' ..
			color.blueish_white .. '" font="Fira Code Nerd Font bold 12">' .. volume .. '</span>'
	end)
end
